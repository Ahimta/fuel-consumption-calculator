...
angular.module('fuelCalculator').service('menuService', [
  '$window',
  'fuelService',
  'periodService',
  'priceService',
  ...
  function (
    ...
    this.getVehiclesMenu = function (
      ...
      return {
        ...
        getDistanceForLiter: function () {
          return vehicleService.getDistanceForLiter(
            selectedYear,
        ...
        selectManufacturer: function (manufacturer) {
          ...
          selectedModel = vehicleService.getFirstModel(
            selectedYear,
            manufacturer,
            selectedModel
          )
        ...
        selectYear: function (year) {
          selectedYear = year
          selectedManufacturer = vehicleService.getFirstManufacturer(
            year,
            selectedManufacturer
          )
          selectedModel = vehicleService.getFirstModel(
        ...
        isSelectedManufacturer: function (manufacturer) {
        ...
        getAvailableManufacturers: function () {
          return vehicleService.getAvailableManufacturers(selectedYear)
        },
        getAvailableModels: function () {
          return vehicleService.getAvailableModels(
            selectedYear,
            selectedManufacturer
          )
        },
    ...
    this.getPeriodMenu = function (initialValue) {
      ...
      menuModel.getSelectedLabel = function () {
        return periodService.getPeriodLabel(menuModel.getSelected())
      }

      menuModel.getValuePerDay = function (valuePerPeriod) {
        return periodService.getValuePerDay(
          menuModel.getSelected(),
          valuePerPeriod
        )
      }
    ...
    this.getWaterPeriodMenu = function (initialValue) {
      ...
      menuModel.getSelectedLabel = function () {
        return periodService.getWaterPeriodLabel(menuModel.getSelected())
      }

      menuModel.getValuePerMonth = function (valuePerPeriod) {
        return periodService.getWaterValuePerMonth(
          menuModel.getSelected(),
          valuePerPeriod
        )
      }
