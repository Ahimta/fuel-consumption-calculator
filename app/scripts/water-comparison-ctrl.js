...
.controller('WaterComparisonCtrl', ['$routeParams', 'fuelService', 'menuService', 'periodService', 'priceService', 'settingsService', 'validationService', 'waterService', function ($routeParams, fuelService, menuService, periodService, priceService, settingsService, validationService, waterService)
{
  ...
  this.calculateVolume = function (measureMenu, periodMenu, costOrVolume, factor)
  {
  ...
  this.calculatePrice = function (measureMenu, periodMenu, costOrVolume, factor)
  {
    var volumePerMonth;
    ...
    {
      case 'cost':
        volumePerMonth = vm.calculateVolume(measureMenu, periodMenu, costOrVolume, factor) / factor
  ...
  this.calculatePriceDifference = function (measureMenu1, periodMenu1, costOrVolume1, measureMenu2, periodMenu2, costOrVolume2, factor)
  {
    var price1 = vm.calculatePrice(measureMenu1, periodMenu1, costOrVolume1, factor)
    var price2 = vm.calculatePrice(measureMenu2, periodMenu2, costOrVolume2, factor)

    return Math.abs(price1 - price2)
  }

  this.calculateVolumeDifference = function (measureMenu1, periodMenu1, costOrVolume1, measureMenu2, periodMenu2, costOrVolume2, factor)
  {
    var volume1 = vm.calculateVolume(measureMenu1, periodMenu1, costOrVolume1, factor)
    var volume2 = vm.calculateVolume(measureMenu2, periodMenu2, costOrVolume2, factor)

    return Math.abs(volume1 - volume2)
  }

  this.getPriceDifferencePercentage = function (measureMenu1, periodMenu1, costOrVolume1, measureMenu2, periodMenu2, costOrVolume2)
  {
    var price1 = vm.calculatePrice(measureMenu1, periodMenu1, costOrVolume1, 1)
    var price2 = vm.calculatePrice(measureMenu2, periodMenu2, costOrVolume2, 1)

    return priceService.getPercentageDifference(price1, price2)
  }

  this.getVolumeDifferencePercentage = function (measureMenu1, periodMenu1, costOrVolume1, measureMenu2, periodMenu2, costOrVolume2)
  {
    var volume1 = vm.calculateVolume(measureMenu1, periodMenu1, costOrVolume1, 1)
    var volume2 = vm.calculateVolume(measureMenu2, periodMenu2, costOrVolume2, 1)
