...
angular.module('fuelCalculator').service('unitService', [function ()
{
  var self = this
  ...
  this.calculateInvertedUnit = function (pairs, excessiveConsumptionPrice, quantity)
  {
    ...
    return self.calculateUnit(invertedPairs, excessiveConsumptionPrice, quantity)
  }
}])